...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/prasszin/autoinstaller/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/prasszin/autoinstaller/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/prasszin/autoinstaller/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/prasszin/autoinstaller/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg      Auto Installer PrasOffc   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg     -------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : prasoffc     ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : PRASOFFC     ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by PrasOfficial ${NC}"
